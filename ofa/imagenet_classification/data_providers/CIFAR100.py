...
class CIFAR100DataProvider(DataProvider):
    DEFAULT_PATH = '~/datasets/cifar100'
    ...
    def save_path(self):
        if self._save_path is None:
            ...
            if not os.path.exists(self._save_path):
                self._save_path = os.path.expanduser('~/data/cifar100')
    ...
    def train_dataset(self, _transforms):
        return datasets.CIFAR100(self.train_dataset, download=True, train=True, transform=_transforms)

    def test_dataset(self, _transforms):
        return datasets.CIFAR100(self.valid_path, download=True, train=False, transform=_transforms)
