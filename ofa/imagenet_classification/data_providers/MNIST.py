...
__all__ = ['MNISTDataProvider']

class MNISTDataProvider(DataProvider):
    DEFAULT_PATH = '~/datasets/mnist'
    ...
    def save_path(self):
        if self._save_path is None:
            ...
            if not os.path.exists(self._save_path):
                self._save_path = os.path.expanduser('~/datasets/mnist')
    ...
    def train_dataset(self, _transforms):
        return datasets.MNIST(self.train_path, download=True, train=True, transform=_transforms)

    def test_dataset(self, _transforms):
        return datasets.MNIST(self.valid_path, download=True, train=False, transform=_transforms)
