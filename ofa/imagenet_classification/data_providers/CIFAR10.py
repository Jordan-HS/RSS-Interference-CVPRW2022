...
class CIFAR10DataProvider(DataProvider):
    ...
    def train_dataset(self, _transforms):
        return datasets.CIFAR10(self.train_path, download=True, train=True, transform=_transforms)

    def test_dataset(self, _transforms):
        return datasets.CIFAR10(self.valid_path, download=True, train=False, transform=_transforms)
