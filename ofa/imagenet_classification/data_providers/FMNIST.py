...
class FMNISTDataProvider(DataProvider):
    ...
    @property
    def data_shape(self):
        return 1, self.active_img_size, self.active_img_size  # C, H, W
    ...
    def save_path(self):
        if self._save_path is None:
            ...
            if not os.path.exists(self._save_path):
                self._save_path = os.path.expanduser('~/datasets/fmnist')
    ...
    def train_dataset(self, _transforms):
        return datasets.FashionMNIST(self.train_path, download=True, train=True, transform=_transforms)

    def test_dataset(self, _transforms):
        return datasets.FashionMNIST(self.valid_path, download=True, train=False, transform=_transforms)
