...
class OFAMobileNetV3Grey(MobileNetV3):
	...
	def __init__(self, n_classes=1000, bn_param=(0.1, 1e-5), dropout_rate=0.1, base_stage_width=None, width_mult=1.0,
		...
		# first conv layer
		first_conv = ConvLayer(1, input_channel, kernel_size=3, stride=2, act_func='h_swish')
		...
		super(OFAMobileNetV3Grey, self).__init__(first_conv, blocks, final_expand_layer, feature_mix_layer, classifier)
	...
	def config(self):
		return {
			'name': OFAMobileNetV3Grey.__name__,
	...
	def load_state_dict(self, state_dict, **kwargs):
		...
		super(OFAMobileNetV3Grey, self).load_state_dict(model_dict)
